...
import { RiVoiceprintLine, RiLockLine } from 'react-icons/ri';
import { useToolAction } from '../hooks/useToolAction';

const Lipsync = () => {
  const handleToolAction = useToolAction('/lipsync');
      ...
      <div className="container mx-auto px-4 py-12 relative">
        ...
        >
          ...
          <p className="text-light/60 text-lg max-w-2xl text-center mb-12">
            Create realistic lip-sync animations for any audio with AI-powered technology.
          </p>
              ...
              <div className="flex flex-col items-center gap-6">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-r from-secondary to-accent p-[1px]">
                  <div className="w-full h-full rounded-2xl bg-black/30 backdrop-blur-xl flex items-center justify-center">
                    <RiVoiceprintLine className="w-10 h-10 text-light" />
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-light/60 mb-8">
                    We're working hard to bring you advanced lip synchronization capabilities.
