...
import { RiImageEditLine, RiLockLine } from 'react-icons/ri';
      ...
      <div className="container mx-auto px-4 py-12 relative">
        ...
        >
          ...
          <p className="text-light/60 text-lg max-w-2xl text-center mb-12">
            Transform your images with AI-powered enhancement, upscaling, and intelligent expansion.
          </p>
              ...
              <div className="flex flex-col items-center gap-6">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-r from-secondary to-accent p-[1px]">
                  <div className="w-full h-full rounded-2xl bg-black/30 backdrop-blur-xl flex items-center justify-center">
                    <RiImageEditLine className="w-10 h-10 text-light" />
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-light/60 mb-8">
                    We're working hard to bring you advanced AI-powered image enhancement and expansion capabilities.
                    Stay tuned for updates!
                  </p>
                  <div className="grid grid-cols-2 gap-4 mb-8">
                    <div className="p-4 rounded-xl bg-black/20 backdrop-blur-sm border border-white/10">
                      <h3 className="text-lg font-medium mb-2">Smart Upscaling</h3>
                      <p className="text-light/60 text-sm">
                        Enhance image resolution while preserving details and quality
                      </p>
                    </div>
                    <div className="p-4 rounded-xl bg-black/20 backdrop-blur-sm border border-white/10">
                      <h3 className="text-lg font-medium mb-2">Content Expansion</h3>
                      <p className="text-light/60 text-sm">
                        Intelligently expand image boundaries with AI-generated content
                      </p>
                    </div>
                  </div>
                </div>
