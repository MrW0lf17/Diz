...
import { RiMovieLine, RiLockLine } from 'react-icons/ri';
import { useToolAction } from '../hooks/useToolAction';

const ImageToVideo = () => {
  const handleToolAction = useToolAction('/image-to-video');
      ...
      <div className="container mx-auto px-4 py-12 relative">
        ...
        >
          ...
          <p className="text-light/60 text-lg max-w-2xl text-center mb-12">
            Transform your still images into dynamic videos with AI-powered motion and effects.
          </p>
              ...
              <div className="flex flex-col items-center gap-6">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-r from-secondary to-accent p-[1px]">
                  <div className="w-full h-full rounded-2xl bg-black/30 backdrop-blur-xl flex items-center justify-center">
                    <RiMovieLine className="w-10 h-10 text-light" />
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-light/60 mb-8">
                    We're working hard to bring you powerful image-to-video conversion capabilities.
