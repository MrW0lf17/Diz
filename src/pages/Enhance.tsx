...
const Enhance = () => {
  const handleToolAction = useToolAction('/expand');
      ...
      <div className="container mx-auto px-4 py-12 relative">
        ...
        >
          ...
          <p className="text-light/60 text-lg max-w-2xl text-center mb-12">
            Upgrade your images with AI-powered enhancement, upscaling, and restoration.
          </p>
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-light/60 mb-8">
                    We're working hard to bring you advanced image enhancement capabilities.
